        ...
        >
          ...
          <div className="inline-flex items-center mb-6 px-4 py-2 bg-white/5 backdrop-blur-md rounded-full group hover:shadow-lg transition-all duration-500">
            <Image
              ...
              priority
            />
            <span className="text-sm font-medium text-blue-300 group-hover:text-blue-100 transition-colors duration-300 ml-2">
              {t("heroSub")}
            </span>
          </div>
          ...
          <div
            className={`flex flex-col sm:flex-row gap-4 justify-center ${
              isRTL ? "md:justify-end sm:flex-row-reverse" : "md:justify-start"
            }`}
          >
            <button
            ...
            >
              <span className="relative z-10 text-white">{t("getQuote")}</span>
            ...
            <button
              ...
              className="px-8 py-4 bg-white/10 backdrop-blur-md rounded-lg font-medium border border-transparent hover:border-white/30 hover:shadow-lg transition-all duration-500 text-white"
            >
              {t("ourServices")}
            </button>
          </div>
          ...
          <div className="mt-16 grid grid-cols-3 gap-6 max-w-md mx-auto md:mx-0">
            {[
              {
                label: isRTL ? "سرعة البرق" : "Lightning Fast",
                color: "text-blue-400",
              },
              { label: isRTL ? "آمن" : "Secure", color: "text-orange-400" },
              { label: isRTL ? "مبتكر" : "Innovative", color: "text-cyan-400" },
            ].map((item, index) => (
              <div
                key={index}
                className="bg-white/5 backdrop-blur-md p-4 rounded-xl hover:-translate-y-2 transition-transform duration-300 hover:shadow-lg border border-white/10"
              >
