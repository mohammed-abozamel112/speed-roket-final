...
const LinkIcon = () => (
  ...
  >
    <path
      d="M10 14a5 5 0 0 1 7.07 0l1.42 1.42a5 5 0 0 1-7.07 7.07l-1.42-1.42a5 5 0 0 1 0-7.07z"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M14 10a5 5 0 0 0-7.07 0l-1.42 1.42a5 5 0 0 0 7.07 7.07l1.42-1.42a5 5 0 0 0 0-7.07z"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            <span className="block">{isRTL ? "خدماتنا" : "Our"}</span>
            <span className="bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-400 bg-[length:200%] bg-clip-text text-transparent animate-text-shine">
              {isRTL ? "المتخصصة" : " Services"}
            </span>
          </h2>
